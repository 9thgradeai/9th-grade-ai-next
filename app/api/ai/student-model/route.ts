/* GET /api/ai/student-model — the learner's long-term profile. Authenticated. */
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const model = await getStudentModel(userId);
    const res = new Response(JSON.stringify(model), {
      headers: {
