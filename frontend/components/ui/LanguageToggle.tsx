...
export default function LanguageToggle() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      onClick={toggleLang}
      className="relative min-h-[44px] px-2.5 flex items-center gap-1.5 text-zinc-400 hover:text-emerald-400 transition-colors rounded-lg hover:bg-emerald-500/5 font-mono text-xs uppercase tracking-wider"
