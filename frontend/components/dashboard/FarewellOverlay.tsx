    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-5 px-6 text-center">
        ...
        <button
          ...
          onClick={onCancel}
          autoFocus
          className="mt-2 rounded-full border border-zinc-700 px-5 py-2.5 text-sm text-zinc-300 transition-colors hover:border-emerald-400/60 hover:text-emerald-400 focus-visible:ring-2 focus-visible:ring-emerald-400/80"
        >
          Actually, I&apos;ll stay
        </button>
      </div>
