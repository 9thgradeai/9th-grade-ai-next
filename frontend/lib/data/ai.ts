...
export const FLASH_NEWS_ITEMS: FlashNews[] = [
  ...
  },
  {
    ...
    tag: "AI",
    title: {
      bn: "চর্চা AI কণ্ঠস্বরে ভাষা বাংলায় সমর্থন যোগ করেছে",
      en: "চর্চা AI Now Supports Bengali Voice",
    },
    text: "চর্চা AI কণ্ঠস্বরে ভাষা বাংলায় সমর্থন যোগ করেছে — আপনি বাংলায় জিজ্ঞাসা করতে পারেন।",
    time: "1d",
    category: { bn: "AI", en: "AI" },
    date: "2026-08-12",
    readTime: 1,
    full:
      "AI টিউটর এখন বাংলাদেশি ইন্টোনেশন ও স্বর ব্যবহার করে আপনার প্রশ্নের উত্তর দিতে পারে। এই ফিচারটি ব্যবহার করতে শুধু 'চর্চা AI'-এর মাইক্রোফোন আইকনে ক্লিক করুন।",
  },
];