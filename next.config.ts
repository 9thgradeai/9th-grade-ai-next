...
const cspDirectives = [
  ...
  "font-src 'self' data:",
  `connect-src 'self' https://*.sentry.io https://api.groq.com https://api.anthropic.com https://api.resend.com https://api.sendgrid.com https://api.pwnedpasswords.com https://*.mux.com`,
