...
const cspDirectives = [
  ...
  "img-src 'self' data: blob: https://*.mux.com",
  "font-src 'self' data:",
  `connect-src 'self' blob: https://*.sentry.io https://api.groq.com https://api.anthropic.com https://api.resend.com https://api.sendgrid.com https://api.pwnedpasswords.com https://*.mux.com`,
